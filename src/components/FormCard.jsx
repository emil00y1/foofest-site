...
const FormCard = ({ setName, setCardNumber, setExp, setCvcData, setPaymentData, paymentData, errorMsg }) => {
    ...
    <>
      <fieldset className="flex flex-col gap-2">
        ...
        <div>
          ...
          <Input id="cardnumber" type="text" name="cnr" placeholder="Ex. 1234 1234 1234 1234" value={cnr} maxLength="16" onChange={handleInputChange} className="placeholder:text-lightgrey" />
        ...
        <div className="flex gap-5">
          <div>
            ...
            <Input id="exdate" type="text" name="my" placeholder="Ex. 12/34" value={my} maxLength="4" onChange={handleInputChange} ref={myInputRef} className="placeholder:text-lightgrey" />
