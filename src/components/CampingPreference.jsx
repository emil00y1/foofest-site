    ...
    <>
      <div className="flex flex-col gap-6">
        <div className="m-0 p-0">
          ...
          <div className="group border-solid border-2 border-foreground rounded cursor-pointer peer-checked:border-yellowaccent  peer-focus-visible:ring peer-focus-visible:ring-orange-700 peer-focus-visible:ring-offset-2  peer-checked:text-yellowaccent flex justify-between">
            ...
            <div className="w-6 h-6 bg-yellowaccent rounded-bl-xl flex peer-checked:opacity-0">
